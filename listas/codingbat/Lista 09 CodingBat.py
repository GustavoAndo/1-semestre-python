...
def middle_way(a, b):
  x = []
  x.append(a[int(((len(a)+1)/2)-1)])
  x.append(b[int(((len(b)+1)/2)-1)])
  return x
...
def squirrel_play(temp, is_summer):
  if is_summer == True:
    if temp > 100 or temp < 60: return False
    else: return True
  if is_summer == False:
    if temp > 90 or temp < 60: return False
    else: return True
...
def alarm_clock(day, vacation):
  ...
  if vacation == True:
    if day <= 5 and day != 0: return '10:00'
    else: return 'off'
